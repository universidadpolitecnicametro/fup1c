...
switch(eleccion)  
{
                   ...
                   printf("1-->cafe $10\n  2-->detergente $20\n 3-->sabritas $10\n 4-->refrescos $15\n 5-->pan $15\n    ");
                      ...
                      switch(opc){
                                  case 1:{
                                       ...
                                       scanf("%d",&nunc);
                                       caftotal=nunc*10;
                                        printf(" tu pago es:  %d ",caftotal);
                                         }break;
                                  case 2:{
                                        printf("elegiste  detergentes   cuantos  ???  \n   ");
                                       scanf("%d",&nund);
                                       dettotal=nund*20;
                                            printf(" tu pago es:  %d ",dettotal);
                                         }break;
                                  case 3:{
                                        printf("elegiste  sabritas  cuantos  ???  \n   ");
                                       scanf("%d",&nuns);
                                       sabtotal=nuns*10;
                                            printf(" tu pago es:  %d ",sabtotal);
                                         }break;
                                  case 4:{
                                       printf("elegiste REFRESCOS  cuantos  ???  \n   ");
                                       scanf("%d",&nunr);
                                       reftotal=nuns*20;
                                            printf(" tu pago es:  %d ",reftotal);
                                         }break;
                                  case 5:{
                                       printf("elegiste  pan  cuantos  ???  \n   ");
                                       scanf("%d",&nunp);
                                       pantotal=nunp*15;
                                            printf(" tu pago es:  %d ",pantotal);
                                         }break;
  ...
  printf(" tu pago es:  %d ",totalventas);                
} 
